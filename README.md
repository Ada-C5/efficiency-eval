...
```ruby
+  def draw_guesses
 +  	# split word and put letters in array => O(n^2)
...
+def overall_mood
 ...
 +    end
 +  end
 +  largest = all.max_by{|key, value| value} => O(n)
